...
- [SEAL-euclidean-distance](https://github.com/clnnn/SEAL-euclidean-distance) - Angular based application that computes euclidean distance between two points using a WASM wrapper of Microsoft SEAL
