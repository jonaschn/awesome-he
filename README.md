...
- [OpenFHE](https://github.com/openfheorg/openfhe-development) - FHE library merged from [PALISADE](#PALISADE), [HElib](#HElib), and [HEAAN](#HEAAN) that supports all major FHE schemes.
