...
- [HEonGPU](https://github.com/Alisah-Ozcan/HEonGPU) -  CUDA-accelerated FHE library on GPUs (BFV, CKKS, MPC).
...
- [HELM](https://github.com/TrustworthyComputing/helm) - Multi-core CPU & GPU evaluation framework for synthesizable HDL designs in the encrypted domain.
